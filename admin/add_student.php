...
if (isset($_POST['form_post_publish'])) {
  try {
    ...
    $statement = $db->prepare("insert into tbl_student (university_id, registration_no, name, faculty, phone_no, address, room_id, session, image) values(?,?,?,?,?,?,?,?,?)");
    $statement->execute(array($_POST['university_id'], $_POST['registration_no'], $_POST['name'], $_POST['faculty'], $_POST['phone_no'], $_POST['address'],  $_POST['room_id'], $_POST['session'], $image_name));
  ...
  <div id="content">
    ...
    <form action="" method="post" enctype="multipart/form-data">
      ...
      <table class="tbl1">
        ...
        <tr><th>Faculty </th></tr>
        <tr><td><input type="text" name="faculty" class="form-control"/> </td></tr>
